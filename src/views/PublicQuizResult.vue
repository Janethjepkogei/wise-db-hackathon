<template>
    <v-container id="quizResult" class="container">
        <v-flex>
            <v-layout id="congratulationsMessage">AWESOME!</v-layout>
            <v-layout id="score">
                <div>Your Score</div>
                <div>8/10</div>
            </v-layout>
...
export default {
    created() {
        store.commit('navigation/setTopBarTitle', 'Teaser Result')
    },
    methods: {
...
<style>
    ...
    #rankChange > main, #scoreRank > main {
        font-size: 20px;
